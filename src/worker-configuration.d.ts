/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 509d738f8aee04218b5e882a65b6bee9)
// Runtime types generated with workerd@1.20251008.0 2025-10-19 enable_ctx_exports,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "RoomDO" | "AIAgent";
	}
	interface Env {
		...
		RoomDO: DurableObjectNamespace<import("./worker").RoomDO>;
		AIAgent: DurableObjectNamespace<import("./worker").AIAgent>;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "TEST_USER_EMAIL" | "TEST_USER_PASSWORD">> {}
}
