...
export type PresenceState = {
  ...
  isAIAgent?: boolean; // True if this is an AI agent cursor
  aiAgentOwner?: string; // User who triggered the AI command
  aiAgentStatus?: "thinking" | "working" | "idle"; // AI agent activity status
};
