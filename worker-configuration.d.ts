/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 5585005a7df5811cefb957cc7a28de99)
// Runtime types generated with workerd@1.20251008.0 2025-10-13 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		AIAgent: DurableObjectNamespace<import("./src/worker").AIAgent>;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "TEST_USER_EMAIL" | "TEST_USER_PASSWORD" | "CLOUDFLARE_API_TOKEN">> {}
}
